  ...
  <div class="tree-table">
    ...
    <div class="tree-table-dbody-div" :style="bodyDivStyle">
      <table cellspacing="0" cellpadding="0" border="0" class="tree-table-body">
        <rowItem :data="rows" :option="option" :currentRowId="selectSingleRowId" @treeIConClick="myTreeIConClick" @rowClick="myRowClick" @checkboxChange="myCheckboxChange"></rowItem>
      </table>

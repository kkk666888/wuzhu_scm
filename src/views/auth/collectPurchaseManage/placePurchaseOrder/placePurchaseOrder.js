        ...
        getTableOption(){
            ...
            let option = {
                ...
                columns:[
                    ...
                    { prop:'consigneeAddr',label:'收货地址'},
                    { prop:'receiverTel',label:'收货人联系方式',width:120 },
                    { prop:'operate',label:'操作',fixed:'right', width:100,render(h,param){
                        return (
                            <div>
                                <el-button type="primary" onClick={()=>{thisObj.selectChannelOpen(param.row)}}>下采购单</el-button>
                            </div>
                        )
                    }}
                ]
            ...
            return {
                columns:[
                    ...
                    { prop:'operate',label:'操作',width:80,render(h,param){
                        return (
                            <el-button type="primary" onClick={()=>{thisObj.placeOrderOpen(param.row)}}>确定</el-button>
                        )
                    } }
                ]
            }

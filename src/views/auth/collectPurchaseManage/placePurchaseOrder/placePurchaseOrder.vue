    ...
    <div class="placePurchaseOrder-main">
        ...
        <my-dialog 
            ...
            <div class="select-channel-dialog">
                <my-table :height="200" :data="selectChannelDialog.data" :option="selectChannelDialog.option"></my-table>
            </div>
        </my-dialog>
                    ...
                    <div class="display-row">
                        ...
                        <div class="display-col">
                            <div class="content">
                                ...
                                <div class="section">
                                    <div>采购价  <span class="lable-2">￥{{placeOrderDialog.detail.price}}</span></div>
                                </div>
                                <div class="section">
                                    <div>{{placeOrderDialog.detail.stockDesc}}</div>
                                    <div>重量：{{placeOrderDialog.detail.weight}}KG</div>
                                    <div>配送至：
                                        <el-input v-model="placeOrderDialog.consigneeAddr" class="address-input" placeholder="请输入" :maxlength="200"></el-input>
                                    </div>
                                </div>
                                <div class="section">
                                    <div>数量：1</div>

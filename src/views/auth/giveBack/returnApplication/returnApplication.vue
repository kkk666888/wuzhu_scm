<template>
    <div class="return-application-main">
        ...
        <!--确认收货弹窗-->
        <my-dialog 
            :title='confirmReceiptDialog.title' 
            :visible.sync='confirmReceiptDialog.visible'
            @onConfirm="confirmReceiptSave()">
            <div class="confirm-receipt-dialog">
                <div class="my-form">
                    <div class="form-item">
                        <label>收货人<my-require/>：</label>
                        <el-input v-model="confirmReceiptModel.signUser" type="text" :maxlength="50" placeholder="请输入"></el-input>
                    </div>
                    <div class="form-item">
                        <label>收货时间<my-require/>：</label>
                        <el-date-picker 
                            value-format="yyyy-MM-dd"
                            v-model="confirmReceiptModel.signTime"  type="date" placeholder="选择日期"></el-date-picker>
                    </div>
        ...
        <!--发起质检弹窗-->
        <my-dialog 
            :title='qualityTestingDialog.title' 
            :visible.sync='qualityTestingDialog.visible'
            @onConfirm="qualityTestingSave()">
            <div class="confirm-receipt-dialog">
                <div class="my-form">
                    <div class="form-item">
                        <label>检验站点<my-require/>：</label>

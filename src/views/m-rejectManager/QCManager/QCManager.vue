<template>
  <div class="QCManager">
    ...
    <!--质检结果弹窗-->
    <my-dialog :title='qcDetail.title' :visible.sync='qcDetail.visible' @onConfirm="confirmQCDetail" :option="detailOption">
      <div class="dialog-content">
        <el-form :model="qcDetailForm" label-width="100px" class="dialog-form">
          <el-tabs value="tab3">
            <el-tab-pane label="订单基本信息" name="tab3">
              <el-form-item label="订单编号" prop="orderNo">
                <el-input type="input" readonly disabled :title="qcDetailForm.orderNo" v-model="qcDetailForm.orderNo"></el-input>
              </el-form-item>
          ...
          <el-tabs value="tab5">
            <el-tab-pane label="质检申请单信息" name="tab5">
              ...
              <el-form-item label="质检原因" prop="inspectionReasonName">
                <el-input type="input" readonly disabled v-model="qcDetailForm.inspectionReasonName"></el-input>
              </el-form-item>
              ...
              <el-form-item label="质检结论" prop="inspectionResult">
                <el-select v-model="qcDetailForm.inspectionResult" v-if="qcDetail.title === '更新质检结果'">
                  <el-option v-for="(item,index) in resultOptions" :key="index" :label="item.itemName" :value="item.itemNo"></el-option>
                </el-select>
                <el-input type="input" readonly disabled v-else v-model="qcDetailForm.inspectionResultName"></el-input>
              </el-form-item>
            </el-tab-pane>
          </el-tabs>
        </el-form>
      ...
      <div class="invalid-dialog">
        <div class="my-form">
          <div class="form-item">
            <label>作废原因
              <my-require/>：</label>
            <el-input type="text" v-model.trim="cancellationModel.invalidReason" :maxlength="50" placeholder="请输入"></el-input>
          </div>
          <div class="form-item form-item-flex">
            <label>描述：</label>
            <el-input v-model="cancellationModel.invalidRemark" type="textarea" :maxlength="255" :rows="5"></el-input>
          </div>
        </div>
      </div>
    </my-dialog>
